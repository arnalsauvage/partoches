...
<label class='inline'>Titre ou interprète:</label><INPUT TYPE='TEXT' NAME='cherche' VALUE='$nom' SIZE='64' MAXLENGTH='128' placeholder='recherche chanson par titre ou nom de l\'interprete><br>
<br>
