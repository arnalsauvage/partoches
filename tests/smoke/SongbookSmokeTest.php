...
class SongbookSmokeTest extends TestCase
{
    ...
    public static function pageProvider(): array
    {
        return [
            ...
            'Inscription' => ['/php/utilisateur/utilisateur_inscription.php', []],
            ...
            'Form Chanson Classic (New)' => ['/php/chanson/chanson_form_classic.php', []],
            'Form Chanson Classic (Edit ID 728)' => ['/php/chanson/chanson_form_classic.php', ['id' => 728]],
