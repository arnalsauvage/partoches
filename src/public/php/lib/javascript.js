...
function actualisePage() {
    ...
    if (requete.readyState == 4) {
        ...
        /* alert("Ready state = 4 !"); */
        document.getElementById("v-" + requete.responseText).src = "data/vignettes/" + requete.responseText;
        /*alert("requete.responseText = "+requete.responseText);*/
        /*alert("Ready state = 4 !");*/
    }
}
...
function demandeVignette(nom) {
    ...
    var data = "image=" + nom + "&largeur_max=240&hauteur_max=200&source=../../images/&destination=../../data/vignettes/";
...
function changeListeImage(formulaire) {
  ...
  l1.options[index].value */
    ...
    document.getElementById("vignette").src = "../../data/vignettes/" + image;
}
